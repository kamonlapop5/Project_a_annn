...
include("./connect.php");
?>
    <br><h2 class="well"><center>จัดการข้อมูลสถานที่</center></h2>
    <div class="col-lg-12 well">
        <p align="right"><a href="./add_place.php" class="btn btn-success glyphicon glyphicon-plus">เพิ่มข้อมูล</a></p>
      <table id= "example" class="table table-bordered table-striped table-hover">
        ...
        <tbody>
<?php
$sql = "select * from builing inner join place on builing.b_id = place.b_id";
...
while($row = mysqli_fetch_array($result)){
  ...
  echo "<td><center><h6><a href=\"./edit_place.php?b_id=$p_id\">แก้ไข</a>
        <a href=\"./delete_place.php?id=$p_id\" onClick=\"javascript:return confirm('คุณต้องการลบข้อมูลใช่หรือไม่');\">ลบ</a></center></h6</td> ";
  echo "</tr>";
  }
  if ($i < 1) {
