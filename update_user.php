...
if ($faculty_id != null or $ma_id != null) {
  $sql_update="update member set m_username = '$m_username', m_password ='$m_password',
  m_fname = '$m_fname', m_lname ='$m_lname', m_phone ='$m_phone', m_email ='$m_email',
  t_id = '$t_id', ma_id = '$ma_id', faculty_id = '$faculty_id' where m_id ='$m_id'";
  $mysqli->query($sql_update) or die($mysqli->error.__LINE__);
  $mysqli->close();
}else {
  $sql_update="update member set m_username = '$m_username', m_password ='$m_password',
  m_fname = '$m_fname', m_lname ='$m_lname', m_phone ='$m_phone', m_email ='$m_email',
  t_id = '$t_id' where m_id ='$m_id'";
  $mysqli->query($sql_update) or die($mysqli->error.__LINE__);
  $mysqli->close();
}
